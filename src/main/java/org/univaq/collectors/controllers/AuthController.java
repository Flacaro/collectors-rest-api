...
public class AuthController {
    ...
    public ResponseEntity<CollectorEntity> register(@Valid @RequestBody Registration collector) {
        ...
        CollectorEntity newCollector = new CollectorEntity(null, collector.getName(), collector.getSurname(), collector.getBirthday(),collector.getUsername(), collector.getEmail(), collector.getPassword());
